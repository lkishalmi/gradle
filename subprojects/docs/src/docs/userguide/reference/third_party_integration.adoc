...
Apache NetBeans::
NetBeans has a built-in support for Gradle projects, since version 11.0. Earlier versions may use the http://plugins.netbeans.org/plugin/44510/gradle-support[Gradle Support] plugin to NetBeans in order to open and run projects with Gradle builds.
